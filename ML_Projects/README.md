...
- [🌍 Geospatial Water Quality Prediction](https://github.com/Sofipet/My_Data_World/tree/main/ML_Projects/Geospatial%20Water%20Quality%20Prediction):  
  Multi-target geospatial regression project for predicting water-quality indicators: dissolved reactive phosphorus, electrical conductance, and total alkalinity. Built a target-wise **ExtraTrees + LightGBM + Ridge stacking pipeline** with GroupKFold validation. Improved hidden leaderboard performance by adding **time-aligned Google Earth Engine features**. 
